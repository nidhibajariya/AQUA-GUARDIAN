...
def main():
    ...
    parser.add_argument("--dataset_dir", type=str, default=os.path.join(os.path.dirname(__file__), "dataset"), help="Path with subfolders clean/ and polluted/")
    parser.add_argument("--batch_size", type=int, default=32)
    parser.add_argument("--epochs", type=int, default=10)
    parser.add_argument("--val_split", type=float, default=0.2)
    parser.add_argument("--output", type=str, default=os.path.join(os.path.dirname(__file__), "model.h5"))
